...
app.config['MYSQL_DATABASE_DB'] = 'MaleOscarWinners'
mysql.init_app(app)


@app.route('/', methods=['GET'])
def index():
    user = {'username': 'Male Oscar Winners Project'}
...
def form_update_post(actor_id):
    ...
    sql_update = """UPDATE oscar_age_male t SET t.Name = %s, t.Age = %s, t.Year = %s, t.Movie = %s WHERE t.id = %s """
...
def api_edit(actor_id) -> str:
    ...
    sql_update = """UPDATE oscar_age_male t SET t.Year = %s, t.Age = %s, t.Name = %s, t.Movie = %s WHERE t.id = %s"""
